...
if __name__ == '__main__':
    ...
    queue=Queue()
    p1=Process(target=voice.record,args=(queue,dictd)) #录音进程
    p2=Process(target=commute,args=(queue,dictd)) #解析进程
    p1.start()
    p2.start()